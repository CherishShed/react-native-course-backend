export const GenerateOtpEmail = (name: string, otp: string) => {
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 24px 0;">
                          <p class="button" title="Reset Password" style="width: 100%; background: #22D172; text-decoration: none; display: inline-block; padding: 10px 0; color: #fff; font-size: 14px; line-height: 21px; text-align: center; font-weight: bold; border-radius: 7px;">${otp}</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          The OTP is only valid for the next 15 minutes.
                        </td>
                      </tr>
